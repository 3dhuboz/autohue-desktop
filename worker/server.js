        ...
        const content = [
            ...
            },
            {
                ...
                text: SORT_BY_TYPE && DETECT_FEATURES
                    ...
                    : 'What is the BODY/PAINT color of the MAIN SUBJECT car in this photo? Reply with ONLY one word from: red, blue, green, yellow, orange, purple, pink, brown, black, white, silver-grey. RULES: The main subject is the car the photographer is FOCUSED ON — usually centered, in sharp focus, and most visually prominent. IGNORE parked/background vehicles, tow trucks, spectator cars. Focus ONLY on the subject car body paint. IGNORE smoke, asphalt, sky, grass, barriers. Dark charcoal/gunmetal/grey-green metallic = silver-grey. Gold/bronze = yellow. Only "green" for vivid bright green.',
            },
        ];
